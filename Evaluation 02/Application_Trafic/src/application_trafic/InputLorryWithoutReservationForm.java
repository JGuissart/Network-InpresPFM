 ...
 * @author Julien
 */
public class InputLorryWithoutReservationForm extends javax.swing.JDialog
{
    ...
    /**
     * Creates new form InputLorryWithoutReservation
     */
    public InputLorryWithoutReservationForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        cbxImmatriculation = new javax.swing.JComboBox();
        ...
        lblImmatriculation.setText("Immatriculation du camion :");
        ...
        cbxImmatriculation.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cbxImmatriculation, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(cbxImmatriculation, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblIdContainer)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnValiderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValiderActionPerformed
        Request = (String)cbxImmatriculation.getSelectedItem();
        for(int i = 0; i < dlm.size(); i++)
            Request += "#" + (String)dlm.getElementAt(i);

        Request += "#" + (String)cbxDestination.getSelectedItem();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InputLorryWithoutReservationForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InputLorryWithoutReservationForm dialog = new InputLorryWithoutReservationForm(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox cbxImmatriculation;
    ...
    public void setModelComboBoxDestination(DefaultComboBoxModel dcbm) {
        cbxDestination.setModel(dcbm);
    }
    
    public void setModelComboBoxImmatriculation(DefaultComboBoxModel dcbm) {
        cbxImmatriculation.setModel(dcbm);
    }
